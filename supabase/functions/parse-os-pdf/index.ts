...
- "Data de Emissão:" → data_emissao: date DD/MM/AAAA, convert to YYYY-MM-DD
- "Data de Entrega:" → data_entrega: date DD/MM/AAAA, convert to YYYY-MM-DD. If "IMEDIATO", set to null
- "Área (m²):" → area_m2: total area in m² (number)

LISTA DE PEÇAS (lower part):
Format: "NÚMERO — [QUANTIDADE X] DESCRIÇÃO COMPRIMENTO X LARGURA"
Examples:
...
Rules: convert commas to dots; default quantity = 1; capitalize descriptions; null for unreadable fields.`;
